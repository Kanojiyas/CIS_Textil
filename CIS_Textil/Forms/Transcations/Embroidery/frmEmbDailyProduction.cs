...
{
    public partial class frmEmbDailyProduction : frmTrnsIface
    {
        private int MaxId;
        public frmEmbDailyProduction()
        {
            InitializeComponent();
        }

        #region Event
        private void frmEmbDailyProduction_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        public void FillControls()
        {
            try
            {
                DBValue.Return_DBValue(this, txtCode, "EmbProdID", Enum_Define.ValidationType.Text);
                ...
                DBValue.Return_DBValue(this, dtProductionDate, "ProdDate", Enum_Define.ValidationType.IsDate);
                ...
                DBValue.Return_DBValue(this, txtTotalStitches, "TotStitches", Enum_Define.ValidationType.Text);
                ...
                MaxId = (int)Math.Round(Localization.ParseNativeDouble(DB.GetSnglValue(string.Format(" Select Isnull(Max(EmbProdID),0) From {0}  Where StoreID={1} and CompID = {2} and BranchID={3} and YearID = {4}", "tbl_EmbProductionMain", Db_Detials.StoreID, Db_Detials.CompID, Db_Detials.BranchID, Db_Detials.YearID))));
